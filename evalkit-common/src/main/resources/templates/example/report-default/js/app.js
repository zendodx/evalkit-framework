...
function renderAttributeV2() {
    ...
    box.innerHTML = `
            ...
            <!-- 图表 -->
            <div class="attr-chart"><canvas id="attrChartV2" height="240"></canvas></div>
            <!-- 卡片列表 -->
            <div id="attrCardsV2" class="attr-cards"></div>
            <div id="copyTipV2" class="copy-tip">已复制</div>`;

    renderCards(list);
    renderAttributionChartV2(list);
...
function renderAttributionChartV2(list) {
    /* 0. 确保 canvas 已经存在于 DOM */
    const canvas = document.getElementById('attrChartV2');
